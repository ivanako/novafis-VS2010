...
Public Class AccesoBD_MySQL
    ...
    Private m_objConexion As MySqlConnection

    ' Variable que guarda la transacción
    Private m_objTransaccion As MySqlTransaction
    ...
    Public Function AbrirConexion() As Boolean
        ...
        Try
            ...
            If m_objConexion Is Nothing Then
                Dim sCadenaConexion As String = LeerConfiguracion("CadenaConexionMySQL")

                ' Instanciar una nueva conexión
                m_objConexion = New MySqlConnection(sCadenaConexion)
...
#Region " PROCEDIMIENTOS ALMACENADOS "
    ...
    ''' Ejecuta un SP que devuelve una lista, la cual se mete en un DataTable. Se usa para consultas de selección (SELECT)
    Public Overloads Function EjecutarSP(ByVal sNombreSP As String, ByRef arrParametros() As MySqlParameter, ByRef dtDatos As DataTable, Optional ByRef iNumFilas As Integer = 0) As Boolean

        Dim objComando As New MySqlCommand()
        Dim objAdaptador As New MySqlDataAdapter()
        ...
        Catch exErrorBD As MySqlException
            ...
            ' Si se ha llegado a abrir conexión, se cierra
            If Not IsNothing(m_objConexion) And m_iNumTransacciones = 0 Then
                m_objConexion.Close()
                m_iNumConexiones = 0
                m_objConexion.Dispose()
            End If
    ...
    ''' Ejecuta un SP que devuelve un valor, en principio sin importar el tipo. Se usa para cuando se devuelven agregados (COUNT, MAX, MIN, ...)
    Public Overloads Function EjecutarSP(ByVal sNombreSP As String, ByRef arrParametros() As MySqlParameter, ByRef sValor As String) As Boolean

        Dim cmmComando As New MySqlCommand()
        Dim iCont As Integer
        Dim bOK As Boolean
    ...
    ''' Ejecuta un SP que no devuelve nada. Se usa para consultas de modificación de datos: INSERT, UPDATE, DELETE
    Public Overloads Function EjecutarSP(ByVal sNombreSP As String, ByRef arrParametros() As MySqlParameter, Optional ByRef iNumFilas As Integer = 0) As Boolean
